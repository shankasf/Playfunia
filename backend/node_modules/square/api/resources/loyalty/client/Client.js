...
const Client_1 = require("../resources/accounts/client/Client");
const Client_2 = require("../resources/programs/client/Client");
const Client_3 = require("../resources/rewards/client/Client");
class LoyaltyClient {
    constructor(options = {}) {
    ...
    get accounts() {
        var _a;
        return ((_a = this._accounts) !== null && _a !== void 0 ? _a : (this._accounts = new Client_1.AccountsClient(this._options)));
    }
    get programs() {
        var _a;
        return ((_a = this._programs) !== null && _a !== void 0 ? _a : (this._programs = new Client_2.ProgramsClient(this._options)));
    }
    get rewards() {
        var _a;
        return ((_a = this._rewards) !== null && _a !== void 0 ? _a : (this._rewards = new Client_3.RewardsClient(this._options)));
    }
    /**
    ...
    __searchEvents() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _response = yield ((_c = this._options.fetcher) !== null && _c !== void 0 ? _c : core.fetcher)({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.SquareEnvironment.Production, "v2/loyalty/events/search"),
                method: "POST",
                headers: _headers,
...
exports.LoyaltyClient = LoyaltyClient;
