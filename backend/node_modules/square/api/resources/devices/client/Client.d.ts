...
export declare class DevicesClient {
     ...
     *     })
     */
    list(request?: Square.ListDevicesRequest, requestOptions?: DevicesClient.RequestOptions): Promise<core.Page<Square.Device, Square.ListDevicesResponse>>;
    /**
     ...
     *     })
     */
    get(request: Square.GetDevicesRequest, requestOptions?: DevicesClient.RequestOptions): core.HttpResponsePromise<Square.GetDeviceResponse>;
    private __get;
