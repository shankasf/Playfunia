...
export declare class SquareClient {
    ...
    get v1Transactions(): V1TransactionsClient;
    get applePay(): ApplePayClient;
    get bankAccounts(): BankAccountsClient;
    ...
    get sites(): SitesClient;
    get snippets(): SnippetsClient;
    get subscriptions(): SubscriptionsClient;
    get teamMembers(): TeamMembersClient;
    get team(): TeamClient;
    get terminal(): TerminalClient;
    get transferOrders(): TransferOrdersClient;
    get vendors(): VendorsClient;
    get cashDrawers(): CashDrawersClient;
